...
#### Script to clean `startup_updater.txt`, removing Ubuntu spam and Flatpak EOL/delisted warnings.
...
unwanted_phrases = [
    ...
    r'Installation finished. No error reported.',
    ...
    r"   The GNOME 46 runtime is no longer supported as of April 17, 2025. Please ask your application developer to migrate to a supported platform.",
    r"   net.christianbeier.Gromit-MPX",

    r"Waiting for cache lock: Could not get lock [\s\S]*",
    r"   com.ktechpit.orion",
    r"   org.freedesktop.Platform 23.08 is no longer receiving fixes and security updates. Please update to a supported runtime version."
...
input_log_file = '/home/federico/Nextcloud/Linux/log/startup_updater.txt' 
